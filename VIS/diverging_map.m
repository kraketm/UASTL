...
% This function Diverging_MAP is based on Kenneth Moreland's code for 
% creating diverging colormaps. Created by Andy Stein.
%
% Ref: https://www.kennethmoreland.com/color-maps/ -- accessed 2024/01/04
% 
% 
% [map] = Diverging_MAP(s,rgb1,rgb2)
%
% Input:
%   * s: vector that goes between zero and one
%   * rgb1: first rgb color
%   * rgb2: second rgb color
%
% Output:
%   * map: divering colormap
%
